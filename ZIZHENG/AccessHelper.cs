...
namespace ZIZHENG
{
    class AccessHelper
    {
        ...
        public AccessHelper()
        {
            conn_str = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + Application.StartupPath + "\\ZIZHENG.mdb;Jet OLEDB:Database Password=41498595;";
           // conn_str = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=E:\\Project\\ZIZHENG.mdb;Jet OLEDB:Database Password=41498595;";
            InitDB();
        }

        public string Path()
        {
            string i = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + Application.StartupPath + "\\ZIZHENG.mdb;Jet OLEDB:Database Password=41498595;";
            return i;
        }
